...
{
    public partial class さんふらわForm : Form
    {
        ...
        private void さんふらわForm_Load(object sender, EventArgs e)
        {
            ...
            this.dgv1.Columns["船名"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            ...
            this.dgv1.Columns["積荷"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            this.dgv1.Columns["割引率"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            ...
            this.dgv1.Columns["積込料"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
        ...
        private void dgv1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex > -1)
            {
                さんふらわInputForm nextForm = new さんふらわInputForm();
        ...
        private void tx計上月_Leave(object sender, EventArgs e)
        {
            try
            {
                ...
                if (this.tx計上月.Text.Length == 2 && this.tx計上年.Text.Length == 4)
                {
                    setMainDataGrid();
                }
            }
