...
namespace ShipReservations
{
    public partial class さんふらわInputForm : Form
    {
        ...
        private void tx車種_TextChanged(object sender, EventArgs e)
        {
        }
        ...
        private void さんふらわInputForm_Load(object sender, EventArgs e)
        {
            set利用区分();
            set車番();
            setドアNO();
