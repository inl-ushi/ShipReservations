...
{
    public partial class 周防灘Form : Form
    {
        ...
        public string ShipName = "周防灘";
        public 周防灘Form()
        {
            InitializeComponent();
        }

        private void 周防灘Form_Load(object sender, EventArgs e)
        {
            ...
            this.dgv1.Columns["発地着地"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            this.dgv1.Columns["種別名"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            this.dgv1.Columns["車長"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            this.dgv1.Columns["NO"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            this.dgv1.Columns["ドアNO"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            this.dgv1.Columns["運転者"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            this.dgv1.Columns["人数"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            this.dgv1.Columns["台数"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            this.dgv1.Columns["定価"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            ...
            set計上年(dt);
            set計上月(dt);
            this.tx燃料価格調整金.Text = set調整金().ToString();
            setMainDataGrid();
        }
        ...
        private void dgv1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex > -1)
            {
                周防灘InputForm nextForm = new 周防灘InputForm();
        ...
        private void saveData()
        {
            try
            {
                ...
                DataView dv = (DataView)this.dgv1.DataSource;

                dv = (DataView)this.dgv1.DataSource;
                int max = dv.Table.Rows.Count;
                int i = 0;
