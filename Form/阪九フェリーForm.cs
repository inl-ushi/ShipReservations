...
{
    public partial class 阪九フェリーForm : Form
    {
        ...
        public string ShipName = "阪九";
        public 阪九フェリーForm()
        {
            InitializeComponent();
        }

        private void 阪九Form_Load(object sender, EventArgs e)
        {
            this.dgv1.Columns["利用区分"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            this.dgv1.Columns["年月日"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            ...
            this.dgv1.Columns["全長"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            this.dgv1.Columns["全幅"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            this.dgv1.Columns["手数料"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            this.dgv1.Columns["調整額"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            this.dgv1.Columns["燃料油価格変動調整金"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            this.dgv1.Columns["請求金額"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
        ...
        private void dgv1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex > -1)
            {
                阪九フェリーInputForm nextForm = new 阪九フェリーInputForm();
        ...
        private void bt新規_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {//編集データあり
                    ...
                    row["請求額"] = nextForm._ShipInfo.請求額;
                    row["請求額"] = Func.Nz(nextForm._ShipInfo.請求額);                    row["調整金"] = "0";
                    row["消費税"] = "0";
