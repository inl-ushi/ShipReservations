...
{
    public partial class 宇和島Form : Form
    {
        ...
        public string ShipName = "宇和島";
        public 宇和島Form()
        {
            InitializeComponent();
        }

        private void 宇和島Form_Load(object sender, EventArgs e)
        {
            ...
            this.dgv1.Columns["船送券番号"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            ...
            this.dgv1.Columns["船送料金"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            this.dgv1.Columns["船送割引"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            this.dgv1.Columns["等級"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            this.dgv1.Columns["大人"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            this.dgv1.Columns["小人"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            this.dgv1.Columns["旅客料金"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            this.dgv1.Columns["旅客割引"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            this.dgv1.Columns["調整金"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            this.dgv1.Columns["合計"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            ...
            this.dgv1.Columns["備考１"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            this.dgv1.Columns["備考２"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
        ...
        private void dgv1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex > -1)
            {
                宇和島InputForm nextForm = new 宇和島InputForm();
        ...
        private void 宇和島Form_Leave(object sender, EventArgs e)
        {
            try
            {
